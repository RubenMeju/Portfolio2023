...
export default function Header() {
  return (
    <div
      id="header"
      className="w-full my-20  flex flex-col gap-4 md:my-32  md:flex-row-reverse md:justify-between"
    >
      ...
      <section className="max-w-md mt-4 flex flex-col gap-4 text-xl text-aling">
        ...
        <p className=" text-slate-300 text-lg">
          ...
          <span className="text-fuchsia-600"> resolver problemas. </span>
        ...
        <div className="flex gap-6">
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 border border-fuchsia-600 px-4 py-2 rounded-xl hover:bg-fuchsia-600 transition-all duration-500"
          >
          ...
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 border border-fuchsia-600 px-4 p-2 rounded-xl hover:bg-fuchsia-600 transition-all duration-500"
          >
